...
// Show Add Modal
function showModal() {
    $('.color-title').text('Add New Color'); 
...
function saveColor() {
    let url = "{{ url('colors') }}"; 
    let formData = new FormData($("#createColorForm")[0]);  
    let submitButton = $('#createColorForm button[type="submit"]');
