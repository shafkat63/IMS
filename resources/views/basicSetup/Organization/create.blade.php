        ...
        <div class="card-body">
            <form id="createForm" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="col-6 mb-4 justify-content-center">
                    ...
                    <img id="itemImageSource1"
                        style="width: 210px;height:126px;border: 1px solid #ddd;padding:3px;cursor:pointer;display:block;">
                </div>
                <div class="row">
                    ...
                    <div class="col-6 mb-4">
                        ...
                        <input type="text" id="tin_number" name="tin_number" class="form-control"
                            placeholder="8965XXXXXXXX" required />
                    </div>
                    ...
                    <div class="col-6 mb-4">
                        ...
                        <input type="text" id="vat_registration_number" name="vat_registration_number"
                            class="form-control" placeholder="4698XXXXXXXX" required />
                    </div>
                    ...
                    <div class="col-6 mb-4">
                        ...
                        <input type="text" id="national_id" name="national_id" class="form-control"
                            placeholder="5552091160" required />
                    </div>
