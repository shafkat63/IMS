...
<div class="card">
    <h5 class="card-header">Payment Status Table</h5>
        ...
        <div class="modal-content p-2 p-md-3">
            <div class="modal-body">
                <div class="modal-header mb-4">
                    <h4 class="modal-title title">Add New Payment Status</h4>
...
<script>
    var table1 = $('#DataTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('all.payment_statuses') !!}', 
        columns: [
            { 
                data: 'id', 
                name: 'serial_number', 
