...
<script>
    var table1 = $('#DataTable').DataTable({
        ...
        columns: [
            ...
            { data: 'product_type', name: 'product_type', title: 'Product Type' },
            { data: 'product_category_id', name: 'product_category_id', title: 'Product Category' },
            { data: 'sub_category_id', name: 'sub_category_id', title: 'Sub Category' },
            { data: 'mode_of_unit', name: 'mode_of_unit', title: 'Mode Of Unit' },
