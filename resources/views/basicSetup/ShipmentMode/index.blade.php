    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-ex-3">
            <div class="navbar-nav me-auto">
                <a class="nav-item nav-link active" href="javascript:void(0)">Shipment Mode Setup</a>
            </div>
            @can('create_shipmentmodes')
...
<div class="card">
    <h5 class="card-header">Shipment Mode Table</h5>
        ...
        <div class="modal-content p-2 p-md-3">
            <div class="modal-body">
                <div class="modal-header mb-4">
                    <h4 class="modal-title title">Add New Shipment Mode</h4>
                ...
                <form id="createForm" class="row g-3" onsubmit="return false">@csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-4">
                            <label class="form-label" for="shipment">Shipment Mode</label>
                            <input type="text" id="shipment" name="shipment" class="form-control"
                                placeholder="BY AIR,etc" />
                        </div>
...
<script>
    var table1 = $('#DataTable').DataTable({
        ...
        columns: [
            ...
            { data: 'name', name: 'name', title: 'Shipment Mode' },
    ...
    function showModal() {
        $('.title').text('Add New Shipment Mode '); 
        $('#createForm')[0].reset();  
        $('#id').val(''); 
    ...
    function showData(id) {
        $.ajax({
            url: `{{ url('shipmentmodes') }}/${id}`,
            type: "GET",
            dataType: "JSON",
            success: function (data) {
                $('#createForm')[0].reset();  
                $('.title').text('Update Shipment Mode');
                $('#id').val(data.id);  
                $('#shipment').val(data.name);  
